...
export default function h(cmd, a, b) {
    ...
    var REG_BASE_CMD_IS_PROBABLY_HTML_ATTRIBUTES_INSTRUCTIONS_STRING = /(?:^|\s)(?:Accept|Alt|Autocomplete|Charset|Chckd|Content|Disabled|For|Href|HttpEquiv|Label|Lang|Multiple|Name|Ph|Property|Rel|Ro|Slctd|Src|Type|Val)(?![A-Za-z0-9])/;
